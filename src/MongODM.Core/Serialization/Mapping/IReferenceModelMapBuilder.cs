...
namespace Etherna.MongODM.Core.Serialization.Mapping
{
    public interface IReferenceModelMapBuilder<TModel>
    {
        ...
        /// <returns>This same model map configuration</returns>
        IReferenceModelMapBuilder<TModel> AddFallbackModelMapSchema(
        ...
        /// Add a fallback model map invoked in case of unrecognized schema id, and absence of fallback serializer
        /// </summary>
        /// <param name="modelMapSchema">The fallback model map schema</param>
        /// <returns>This same model map configuration</returns>
        IReferenceModelMapBuilder<TModel> AddFallbackModelMapSchema(
        ...
        /// <returns>This same model map configuration</returns>
        IReferenceModelMapBuilder<TModel> AddSecondaryModelMapSchema(
            string id,
            Action<BsonClassMap<TModel>>? modelMapSchemaInitializer = null,
            string? baseModelMapSchemaId = null);
