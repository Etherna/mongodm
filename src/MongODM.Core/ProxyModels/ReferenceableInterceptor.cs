...
namespace Etherna.MongODM.Core.ProxyModels
{
        ...
        where TModel : class, IEntityModel<TKey>
    {
            ...
            : base(additionalInterfaces)
        {
            ...
            while (!dbContext.RepositoryRegistry.ModelRepositoryMap.ContainsKey(repositoryModelType))
            {
            ...
            repository = dbContext.RepositoryRegistry.ModelRepositoryMap[repositoryModelType];
        }
